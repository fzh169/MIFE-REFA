...
class MyModel(nn.Module):
    ...
    def forward(self, frame0, frame2):
        ...
        flow_0, range_0, corr02_0, corr20_0 = self.flow0(feat00, feat02, lap00, lap02)
        flow_1, range_1, corr02_1, corr20_1 = self.flow1(feat10, feat12, lap10, lap12)
        flow_2, range_2, corr02_2, corr20_2 = self.flow2(feat20, feat22, lap20, lap22)
        flow_3, range_3, corr02_3, corr20_3 = self.flow3(feat30, feat32, lap30, lap32)
...
class BasicFlow(nn.Module):
    ...
    def forward(self, feat0, feat2, lap0, lap2):
