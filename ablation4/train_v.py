...
def parse_args():
    ...
    # Directory Setting
    parser.add_argument('--data_dir', type=str, default='/root/autodl-tmp/vimeo_triplet/')
...
def main():
    ...
    train_dataset = Vimeo90K_interp(args.data_dir, "tri_trainlist.txt", random_crop=(256, 256), resize=None,
                                    augment_s=True, augment_t=True)
    sampler = DistributedSampler(train_dataset)
    train_loader = DataLoader(dataset=train_dataset, batch_size=args.batch_size, num_workers=48, pin_memory=True,
                              sampler=sampler)
