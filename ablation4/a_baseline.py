...
class MyModel(nn.Module):
    def __init__(self, args):
        ...
        self.flow0 = BasicFlow(dim=64, part_size=8, up_factor=8)
        self.flow1 = BasicFlow(dim=128, part_size=8, up_factor=16)
        self.flow2 = BasicFlow(dim=192, part_size=16, up_factor=32)
        self.flow3 = BasicFlow(dim=256, part_size=16, up_factor=64)
