...
class MyModel(nn.Module):
    def __init__(self, args):
        ...
        self.sn = ScoreNet(dim=(16, 32, 64, 96), in_ch=27, out_ch=9, kernel=3, dilation=(2, 4, 8, 16))

        self.flow0 = RefineFlow(dim=64,  part_size=8,  up_factor=2,  kernel=3)
        self.flow1 = RefineFlow(dim=128, part_size=8,  up_factor=4,  kernel=3)
        self.flow2 = RefineFlow(dim=192, part_size=16, up_factor=8,  kernel=3)
        self.flow3 = RefineFlow(dim=256, part_size=16, up_factor=16, kernel=3)
    ...
    def forward(self, frame0, frame2):
        ...
        flow_0, range_0, corr02_0, corr20_0 = self.flow0(feat00, feat02, score00, score02)
        flow_1, range_1, corr02_1, corr20_1 = self.flow1(feat10, feat12, score10, score12)
        flow_2, range_2, corr02_2, corr20_2 = self.flow2(feat20, feat22, score20, score22)
        flow_3, range_3, corr02_3, corr20_3 = self.flow3(feat30, feat32, score30, score32)
