...
class MyModel(nn.Module):
    ...
    def forward(self, frame0, frame2):
        ...
        flow10 = self.rm(flow10_0, flow10_1, flow10_2, range1_0, range1_1)
        flow12 = self.rm(flow12_0, flow12_1, flow12_2, range1_0, range1_1)
        flow02 = self.rm(flow02_0, flow02_1, flow02_2, range0_0, range0_1)
        flow20 = self.rm(flow20_0, flow20_1, flow20_2, range0_0, range0_1)
