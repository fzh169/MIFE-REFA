...
class MyModel(nn.Module):
    def __init__(self, args):
        ...
        self.fe = FeatureExtractor(dim=(32, 64))
    ...
    def forward(self, frame0, frame2):
        ...
        feat00 = self.fe(frame0 - mean_f)
        feat02 = self.fe(frame2 - mean_f)

        flow10_0, flow12_0, flow02_0, flow20_0 = self.flow0(feat00, feat02)

        flow10 = self.fn(flow10_0)
        flow12 = self.fn(flow12_0)
        flow02 = self.fn(flow02_0)
        flow20 = self.fn(flow20_0)
        ...
        if self.training:
            ...
            return {'frame1': frame1_hat, 'g0': g0}
        else:
