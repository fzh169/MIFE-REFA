...
class MyModel(nn.Module):
    ...
    def forward(self, frame0, frame2):
        ...
        flow10_0, flow12_0, range1_0, flow02_0, flow20_0, range0_0 = self.flow0(feat00, feat02)
        flow10_1, flow12_1, range1_1, flow02_1, flow20_1, range0_1 = self.flow1(feat10, feat12)
        flow10_2, flow12_2, range1_2, flow02_2, flow20_2, range0_2 = self.flow2(feat20, feat22)
        ...
        flow02 = self.fn(self.rm(flow02_0, flow02_1, flow02_2, range0_0, range0_1))
        flow20 = self.fn(self.rm(flow20_0, flow20_1, flow20_2, range0_0, range0_1))
...
class BasicFlow(nn.Module):
    ...
    def forward(self, feat0, feat2):
        ...
        flow12, range1, flow02, range0 = self.estimate(q0, k2, pos, bias, s1, s2, H, W)
        flow10, range1, flow20, range0 = self.estimate(q2, k0, pos, bias, s1, s2, H, W)
        ...
        return flow10, flow12, range1, flow02, flow20, range0

    def estimate(self, q, k, pos, bias, s1, s2, H, W):

        flow1_00, range1_00, flow0_00, range0_00 = self.part(q, k, pos, bias, (False, False))
        flow1_01, range1_01, flow0_01, range0_01 = self.part(q, k, pos, bias, (False, True))
        flow1_10, range1_10, flow0_10, range0_10 = self.part(q, k, pos, bias, (True, False))
        flow1_11, range1_11, flow0_11, range0_11 = self.part(q, k, pos, bias, (True, True))
        ...
        return flow1, range1, flow0, range0
