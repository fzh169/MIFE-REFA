...
class MyModel(nn.Module):
    ...
    def forward(self, frame0, frame2):
        ...
        flow10_0, flow12_0, range1_0, corr02_0, corr20_0 = self.flow0(feat00, feat02)
        flow10_1, flow12_1, range1_1, corr02_1, corr20_1 = self.flow1(feat10, feat12)
        flow10_2, flow12_2, range1_2, corr02_2, corr20_2 = self.flow2(feat20, feat22)
        ...
        corr02 = self.cn(torch.cat([corr02_0, corr02_1, corr02_2], dim=1))
        corr20 = self.cn(torch.cat([corr20_0, corr20_1, corr20_2], dim=1))

        f10 = self.backwarp(flow10, frame0)
        f12 = self.backwarp(flow12, frame2)

        alpha = self.om(corr20 - corr02)
        ...
        if self.training:
            ...
            g0 = self.generate(flow10_0, flow12_0, corr02_0, corr20_0, frame0, frame2)[:, :, 0:h0, 0:w0]
            g1 = self.generate(flow10_1, flow12_1, corr02_1, corr20_1, frame0, frame2)[:, :, 0:h0, 0:w0]
            g2 = self.generate(flow10_2, flow12_2, corr02_2, corr20_2, frame0, frame2)[:, :, 0:h0, 0:w0]
    ...
    def generate(self, flow10, flow12, corr02, corr20, frame0, frame2):
...
class BasicFlow(nn.Module):
    ...
    def forward(self, feat0, feat2):
        ...
        flow12, range1, corr02 = self.estimate(q0, k2, pos, bias, s1, s2, H, W)
        flow10, range1, corr20 = self.estimate(q2, k0, pos, bias, s1, s2, H, W)
        ...
        return flow10, flow12, range1, corr02, corr20

    def estimate(self, q, k, pos, bias, s1, s2, H, W):

        flow1_00, range1_00, corr0_00 = self.part(q, k, pos, bias, (False, False))
        flow1_01, range1_01, corr0_01 = self.part(q, k, pos, bias, (False, True))
        flow1_10, range1_10, corr0_10 = self.part(q, k, pos, bias, (True, False))
        flow1_11, range1_11, corr0_11 = self.part(q, k, pos, bias, (True, True))
    ...
    def part(self, q, k, pos, bias, shift):
        ...
        corr0 = rearrange(corr, 'b (h w) t -> b t h w', h=self.part_h)[:, :, cut[0], cut[1]]
        corr0 = torch.max(corr0, dim=1)[0].unsqueeze(1)
