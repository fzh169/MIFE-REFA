...
class MyModel(nn.Module):
    ...
    def forward(self, frame0, frame2):
        ...
        feat20 = self.fe(frame0 - mean_f)
        feat22 = self.fe(frame2 - mean_f)

        flow10_2, flow12_2, flow02_2, flow20_2 = self.flow2(feat20, feat22)

        flow10 = self.fn(flow10_2)
        flow12 = self.fn(flow12_2)
        flow02 = self.fn(flow02_2)
        flow20 = self.fn(flow20_2)
        ...
        if self.training:
            ...
            return {'frame1': frame1_hat, 'g2': g2}
        else:
